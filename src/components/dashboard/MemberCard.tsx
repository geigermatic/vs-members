    ...
    <div className="bg-white rounded-lg shadow-sm">
      ...
      <div className="p-4 pb-0">
        <div className="flex items-baseline">
          <div>
            <h3 className="text-xl font-semibold text-slate-800">{member.member_name}</h3>
      ...
      <div className="flex">
        {/* Navy Blue Score Panel */}
        <div className="w-2/3 bg-gradient-to-br from-blue-900 to-blue-800 p-6 rounded-lg">
          <div className="flex gap-6">
            {/* Left side of blue panel (2/3) */}
            <div className="w-2/3">
              {/* Status Bar */}
            ...
            {/* Right side of blue panel (1/3) - Score Actions Panel */}
            <div className="w-1/3">
              {/* Dashboard Status */}
